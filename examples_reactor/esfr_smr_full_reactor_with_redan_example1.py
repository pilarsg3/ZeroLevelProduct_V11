...
_REDAN_Z_TOP      = _RV_STRAIGHT_H                        # top rim at RV straight section (absolute z)
_REDAN_Z_KNEE     = _CORE_Z_BOTTOM + _CORE_HEIGHT         # knee at core top (absolute z)
_REDAN_Z_BOTTOM   = _DIAGRID_TOP_Z                        # bottom positioned at diagrid top (absolute z)
_REDAN_Z_SHOULDER = 6.500                                 # shoulder height (absolute z)
