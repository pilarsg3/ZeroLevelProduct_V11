...
# OLDER VERSION — only needed to invert centroid-based placement
# (move_center_to). Placement is now origin-based (build_solid places the
# component's LOCAL ORIGIN at center_coords), so no bbox/centroid estimate
# is required:
