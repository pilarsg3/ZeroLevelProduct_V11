...
def create_top_plate(
    ...
    *,
    ...
    # OLDER VERSION (centroid-based) — with an ASYMMETRIC hole pattern the
    # plate centroid shifts away from the holes, so move_center_to displaced
    # the whole plate (holes included) off its intended position:
